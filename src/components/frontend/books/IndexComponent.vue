    ...
    <div class="container">
        <div class="card border-0 shadow rounded-3 my-3">
            <div class="card-body p-4 p-sm-5">
                <h5 class="card-title mb-2 fw-light fs-5">Search a book</h5>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 mt-2">
                        <div class="mb-3">
                            <button class="btn btn-success btn-lg mt-1" @click="applyFilter()">Search</button>&nbsp;
            ...
            <div class="card-body p-4 p-sm-5">
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <h5 class="card-title mb-2 fw-light fs-5">List of all books</h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mt-2">
