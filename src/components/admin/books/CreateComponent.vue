    ...
    <div class="container">
        <div class="card border-0 shadow rounded-3 my-3">
            <div class="card-body p-4 p-sm-5">
                <h5 class="card-title mb-2 fw-light fs-5">Add a new Book <router-link class="btn btn-link"
                        :to="{ name: 'admin.books' }">Back</router-link></h5>
                <form @submit.prevent="onSubmit" @submit="createBook()">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mt-2">
                            <button class="btn btn-success btn-lg mt-1 ml-2" type="submit">Submit Book</button>
                        </div>
                    </div>
                </form>
            </div>
