    ...
    <div class="container">
        <div class="card border-0 shadow rounded-3 my-3">
            <div class="card-body p-4 p-sm-5">
                <h5 class="card-title mb-2 fw-light fs-5">Edit a Book <router-link class="btn btn-link"
                ...
                <form @submit.prevent="onSubmit" @submit="updateBook()">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mt-2">
                            <button class="btn btn-success btn-lg mt-1 ml-2" type="submit">Update Book</button>
                        </div>
                    </div>
                </form>
            </div>
